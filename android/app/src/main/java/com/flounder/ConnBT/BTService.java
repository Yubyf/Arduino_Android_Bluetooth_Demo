...
/**
 * Setting up and managing BT connections with other devices.
 * It has a thread that listens for incoming connections, a thread
 * for connecting with a device, and a thread for performing data
...
public class BTService {
    ...
    // Quote: [from Android SDK Docs]
    // If you are connecting to a Bluetooth serial board then try using the well-known
    // SPP UUID 00001101-0000-1000-8000-00805F9B34FB.
    // However if you are connecting to an Android peer then please generate your own
    // unique UUID.
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            // Using a temporary object that is later assigned to mmServerSocket
...
//                }
        ...
        public void run() {
            try {
                ...
                connectionError(mContext.getResources().getString(R.string.text_error_conn_failed));
                return;
            }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    connectionError(mContext.getResources().getString(R.string.text_error_conn_lost));
                    // Start the service over to restart listening mode
                    BTService.this.start();
                    break;
                }
